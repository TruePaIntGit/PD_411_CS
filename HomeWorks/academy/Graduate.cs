...
namespace Academy
{
    ...
    {
        public string SubjectDiploma {  get; set; }
        public Graduate(
        ...
        public Graduate(Graduate other) : base(other) //здесь нефвно происходит Upcase - преобразование объекта доернего класса в объект базового класса.
        {
            this.SubjectDiploma = other.SubjectDiploma;
        ...
        {
            base.Info();
            Console.WriteLine($"\t{SubjectDiploma}");
        }

        public override string ToString()
        {
            return base.ToString() + SubjectDiploma;
        }
        public override string ToFileString()
        {
            return base.ToFileString() + $",{SubjectDiploma}";
        }
